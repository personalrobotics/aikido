...
base::PlannerStatus MyBITstar::solve(
...
ompl::base::PlannerStatus MyBITstar::solveAfterLoadingSamples(
...
ompl::base::PlannerStatus MyBITstar::solveAndSaveSamples(
    std::string filename, double solveTime)
{
  mode_ = SAVE_SAMPLES;
