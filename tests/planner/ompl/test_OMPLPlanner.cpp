...
TEST_F(PlannerTest, GetSpaceInformationCreatesGeometricStateSpace)
{
  ...
  auto ss
      = ompl_dynamic_pointer_cast<aikido::planner::ompl::GeometricStateSpace>(
          si->getStateSpace());
...
TEST_F(PlannerTest, GetSpaceInformationCreatesValidityChecker)
{
  ...
  auto vc
      = ompl_dynamic_pointer_cast<aikido::planner::ompl::StateValidityChecker>(
...
TEST_F(PlannerTest, GetSpaceInformationCreatesMotionValidator)
{
  ...
  auto mvalidator
      = ompl_dynamic_pointer_cast<aikido::planner::ompl::MotionValidator>(
