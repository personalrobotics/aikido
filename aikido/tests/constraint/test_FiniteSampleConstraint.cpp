...
TEST(SingleSampleConstraint, SingleCyclicSampleGenerator)
{
  Eigen::VectorXd v(1);
  v(0) = -2;
  ...
  std::unique_ptr<SampleGenerator> generator = constraint.createCyclicSampleGenerator();
...
TEST(SingleSampleConstraint, FiniteCyclicSampleGenerator)
{
  Eigen::Vector2d v1(0, 1);
  Eigen::Vector2d v2(2, 3);
