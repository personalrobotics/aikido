...
class MoveEndEffectorTwistVectorField : public BodyNodePoseVectorField
{
public:
  /// Constructor
  ///
  ...
  MoveEndEffectorTwistVectorField(
...
#endif // ifndef
       // AIKIDO_PLANNER_VECTORFIELD_MOVEENDEFFECTORTWISTVECTORFIELD_HPP_