#ifndef AIKIDO_STATESPACE_CARTESIANPRODUCTINTERPOLATOR_HPP_
#define AIKIDO_STATESPACE_CARTESIANPRODUCTINTERPOLATOR_HPP_
...
class CartesianProductInterpolator : public Interpolator
{
public:
  /// Constructs a \c GeodesicInterpolator for \c _stateSpace.
  ///
  /// \param _stateSpace used for interpolation
  CartesianProductInterpolator(statespace::CartesianProductPtr _stateSpace,
                                std::vector<InterpolatorPtr> mInterpolators);

  virtual ~CartesianProductInterpolator() = default;
...
private:
  statespace::CartesianProductPtr mStateSpace;
  std::vector<InterpolatorPtr> mInterpolators; 
};
...
#endif // ifndef AIKIDO_STATESPACE_CARTESIANPRODUCTINTERPOLATOR_HPP_
