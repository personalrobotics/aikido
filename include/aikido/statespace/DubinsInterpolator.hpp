#ifndef AIKIDO_STATESPACE_DUBINSINTERPOLATOR_HPP_
#define AIKIDO_STATESPACE_DUBINSINTERPOLATOR_HPP_
...
class DubinsInterpolator : public Interpolator
{
public:
  /// Constructs a \c GeodesicInterpolator for \c _stateSpace.
  ///
  /// \param _stateSpace used for interpolation
  explicit DubinsInterpolator(statespace::ConstStateSpacePtr _stateSpace,
                              double turningRadius = 1.0);

  virtual ~DubinsInterpolator() = default;
...
#endif // ifndef AIKIDO_STATESPACE_DUBINSINTERPOLATOR_HPP_
