#ifndef AIKIDO_CONTROL_SIMBARRETFINGERSPREADCOMMANDEXECUTOR_HPP_
#define AIKIDO_CONTROL_SIMBARRETFINGERSPREADCOMMANDEXECUTOR_HPP_
...
class SimBarrettFingerSpreadCommandExecutor
{
public:
  /// Constructor.
...
using SimBarrettFingerSpreadCommandExecutorPtr = std::shared_ptr<SimBarrettFingerSpreadCommandExecutor>;
