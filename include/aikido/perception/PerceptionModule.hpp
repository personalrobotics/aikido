...
public:
    ...
    /// Run the specific detector via a service call or ROS message reception, lookup the transform between
    /// the specified frames, load object models for new objects, compute their pose, and update 
    /// the list of DART Skeletons that represents the world.
    ///
    ...
    virtual bool detectObjects(dart::simulation::WorldPtr env, ros::Duration timeout, ros::Time timestamp) = 0;
